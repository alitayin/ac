      ...
      <main className="flex-1 p-4 pb-12">
        <div className="flex flex-col mx-auto md:max-w-3xl space-y-8">
          <header className="mt-6 space-y-2">
            <h1 className="text-3xl font-semibold tracking-tight leading-tight">About Agora.Cash</h1>
            <p className="text-sm font-normal tracking-tight text-muted-foreground leading-relaxed">
          ...
          <Card className="rounded-xl border border-blue-100/30 dark:border-blue-500/20 shadow-sm">
            <CardHeader className="pb-2">
              <CardTitle className="text-lg font-semibold tracking-tight">The site</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm font-normal tracking-tight leading-relaxed text-foreground/90">
              <p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight leading-tight">About Star Shard and Star Crystal</h2>
            <div className="flex flex-wrap gap-3 items-center text-sm text-muted-foreground">
              <div className="flex items-center gap-2 rounded-full border border-blue-100/40 dark:border-blue-500/25 bg-blue-50/50 dark:bg-blue-500/5 px-3 py-1">
                ...
                <span className="font-normal tracking-tight text-foreground">Star Shard (SS)</span>
              </div>
              <div className="flex items-center gap-2 rounded-full border border-blue-100/40 dark:border-blue-500/25 bg-blue-50/50 dark:bg-blue-500/5 px-3 py-1">
                <Avatar className="h-6 w-6">
                ...
                <span className="font-normal tracking-tight text-foreground">Star Crystal (SC)</span>
              </div>
            </div>
          </div>

          <Card className="rounded-xl border border-blue-100/30 dark:border-blue-500/20 shadow-sm">
            <CardContent className="pt-6 space-y-5 text-sm font-normal tracking-tight leading-relaxed text-foreground/90">
              <p>
              ...
              <div className="rounded-lg border border-blue-200/50 dark:border-blue-500/30 bg-blue-50/60 dark:bg-blue-500/10 px-4 py-3">
                <p className="text-xs font-normal uppercase tracking-wide text-blue-700 dark:text-blue-300 mb-1">
                  Original sale prices (reference)
                </p>
                <ul className="text-sm font-normal tracking-tight space-y-1 list-disc list-inside marker:text-blue-500/80">
          ...
          <section className="mt-10 pt-2">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm font-normal tracking-tight text-blue-500 hover:text-blue-600 hover:underline"
            >
