            ...
            <div className="space-y-4">
                        ...
                        if (isWalletConnected) {
                          ...
                          if (maxBalance > 0) {
                            ...
                            toast({
                              ...
                              description: "Your wallet balance is empty",
                              variant: "destructive",
                            });
                          }
                        } else {
                    ...
                    {selectedBuyToken && (
                      <TokenSelector
                        ...
                        onTokenSelect={(tokenId, tokenName) => {
                          setSelectedBuyToken({ id: tokenId, name: tokenName })
                          setSpendAmount('')
                          setReceiveAmount('0')
                          setAvgExecutionPrice(0)
                          setSlippage(0)
                ...
                {isSwapActivated ? (
                  <>
                    <Button 
                      ...
                      variant="ghost"
                      onClick={() => window.open(`https://cashtab.com/#/token/${tokenData.tokenId}`, '_blank')}
                    >
                      Cashtab
                    </Button>
                    <Button 
              ...
              {!riskAcknowledged && (
                <div className="flex items-start space-x-2 mt-3 p-3 bg-muted/50 rounded-lg">
                  <Checkbox 
                    id="risk-acknowledgement-mobile" 
                  ...
                  />
                  <label
                    htmlFor="risk-acknowledgement-mobile"
              ...
              <Card className="rounded-3xl py-2 px-0 border-none shadow-none">
                ...
                <div className="space-y-2 bg-background p-4 rounded-2xl border mt-2 transition-all hover:bg-muted/50">
                  ...
                  <div className="mt-2 space-y-1">
                    {errorMessage ? (
                      <div className="text-sm text-red-500">
                        {errorMessage.replace('Exceeds available amount', 'Exceeds available amount:')}
                      </div>
                    ) : avgExecutionPrice > 0 && (
                      <>
                        <div className="text-sm text-muted-foreground">
